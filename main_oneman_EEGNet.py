...
from Dataset.EMGDataset_oneman import EMGDataset
...
def main():
    ...
    for i in range(0, 7):
        dataset = EMGDataset(opt.clip_length, opt.step, [i], with_remix=False, get_first_part=True,
                             with_extra_small=False, first_is_train=True, first_part_rate=0.5)
        test_dataset = EMGDataset(opt.clip_length, opt.step, [i], with_remix=False, get_first_part=False,
                                  with_extra_small=True, first_is_train=True, first_part_rate=0.5)
